...
export const uploadPdf = async (event: React.ChangeEvent<HTMLInputElement>, onFileUpload: (fileUrl: string, file: File) => void, onBackendHighlights: (highlights: IHighlight[]) => void) => {
