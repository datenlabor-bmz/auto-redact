...
export const analyzePdf = async (currentPdfFile: File, customPrompt: string, setHighlights: (highlights: IHighlight[]) => void, setIsAnalyzing: (isAnalyzing: boolean) => void) => {
